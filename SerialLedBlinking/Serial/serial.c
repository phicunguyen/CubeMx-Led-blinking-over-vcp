...
static uint8_t buffer[564];			//hold the message in ascii that send to serial port.
...
static void s_write(struct AdapterTypedef_t *p_adapter, uint8_t *p_buf, uint16_t size);
static void s_read(struct AdapterTypedef_t *p_adapter, uint8_t *p_buf, uint16_t size);
...
/***** local data objects ****************************************************/
static void s_send(struct AdapterTypedef_t *p_adapter, uint8_t *p_buf, uint16_t size) {
